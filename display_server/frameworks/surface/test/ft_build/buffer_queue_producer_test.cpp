...
*                  5. check ret
 */
TEST_F(BufferQueueProducerTest, QueueSize001)
{
...
*                  3. check ret
 */
TEST_F(BufferQueueProducerTest, ReqCan001)
{
...
*                  3. check ret
 */
TEST_F(BufferQueueProducerTest, ReqCan002)
{
    IBufferProducer::RequestBufferReturnValue retval;
    GSError ret = bqp->RequestBuffer(requestConfig, bedata, retval);
    ASSERT_EQ(ret, OHOS::GSERROR_OK);
...
*                  2. check ret
 */
TEST_F(BufferQueueProducerTest, ReqCan003)
{
...
*                  3. check ret
 */
TEST_F(BufferQueueProducerTest, ReqFlu001)
{
    IBufferProducer::RequestBufferReturnValue retval;
    GSError ret = bqp->RequestBuffer(requestConfig, bedata, retval);
    ASSERT_EQ(ret, OHOS::GSERROR_OK);
...
*                  4. check ret
 */
TEST_F(BufferQueueProducerTest, ReqFlu002)
{
    IBufferProducer::RequestBufferReturnValue retval;
    GSError ret = bqp->RequestBuffer(requestConfig, bedata, retval);
    ASSERT_EQ(ret, OHOS::GSERROR_OK);
