...
TEST_F(BufferSharedTest, RequestBuffer001)
{
...
TEST_F(BufferSharedTest, RequestBufferDiff001)
{
...
* */
TEST_F(BufferSharedTest, FlushBuffer001)
{
    PART("FlushBuffer") {
        GSError ret1, ret2;
...
* */
TEST_F(BufferSharedTest, AquiredBuffer001)
{
    PART("AquiredBuffer") {
        GSError ret1, ret2;
...
* */
TEST_F(BufferSharedTest, CancelBuffer001)
{
    PART("CancelBuffer") {
        GSError ret1, ret2;
...
* */
TEST_F(BufferSharedTest, ReleaseBuffer001)
{
    PART("ReleaseBuffer") {
        GSError ret1, ret2;
