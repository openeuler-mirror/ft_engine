...
*                  2. check ret
 */
TEST_F(SurfaceUtilsTest, GetInstance001)
{
...
*                  2. check ret
 */
TEST_F(SurfaceUtilsTest, Add001)
{
...
*                  2. check ret
 */
TEST_F(SurfaceUtilsTest, Add002)
{
...
*                  2. check ret
 */
TEST_F(SurfaceUtilsTest, GetSurface001)
{
...
*                  2. check ret
 */
TEST_F(SurfaceUtilsTest, GetSurface002)
{
...
*                  4. check ret
 */
TEST_F(SurfaceUtilsTest, GetSurface003)
{
...
*                  2. check ret
 */
TEST_F(SurfaceUtilsTest, Remove001)
{
...
*                  2. check ret
 */
TEST_F(SurfaceUtilsTest, Remove002)
{
