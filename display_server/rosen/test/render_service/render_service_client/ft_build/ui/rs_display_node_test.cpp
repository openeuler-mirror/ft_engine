 ...
 * @tc.type:FUNC
 */
TEST_F(RSDisplayNodeTest, Create001)
{
    /**
 ...
 * @tc.type:FUNC
 */
TEST_F(RSDisplayNodeTest, GetType001)
{
    RSDisplayNodeConfig c;
    RSDisplayNode::SharedPtr displayNode = RSDisplayNode::Create(c);
    ASSERT_TRUE(displayNode != nullptr);
 ...
 * @tc.type:FUNC
 */
TEST_F(RSDisplayNodeTest, TakeSurfaceCapture001)
{
    /**
    * @tc.steps: step1. create RSDisplayNode
    */
 ...
 * @tc.type:FUNC
 */
TEST_F(RSDisplayNodeTest, SetSecurityDisplay001)
{
    /**
    * @tc.steps: step1. create RSDisplayNode
    */
 ...
 * @tc.type:FUNC
 */
TEST_F(RSDisplayNodeTest, SetSecurityDisplay002)
{
    /**
    * @tc.steps: step1. create RSDisplayNode
    */
 ...
 * @tc.type:FUNC
 */
TEST_F(RSDisplayNodeTest, GetSecurityDisplay001)
{
    /**
    * @tc.steps: step1. create RSDisplayNode
    */
 ...
 * @tc.type:FUNC
 */
TEST_F(RSDisplayNodeTest, SetScreenId001)
{
    /**
    * @tc.steps: step1. create RSDisplayNode
    */
