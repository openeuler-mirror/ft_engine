 ...
 */
TEST_F(VSyncConnectionTest, RequestNextVSync001)
{
...
* CaseDescription: 1. call RequestNextVSync
 */
TEST_F(VSyncConnectionTest, RequestNextVSync002)
{
 ...
 */
TEST_F(VSyncConnectionTest, SetVSyncRate001)
{
...
* CaseDescription: 1. call SetVSyncRate
 */
TEST_F(VSyncConnectionTest, SetVSyncRate002)
{
    VSyncConnectionTest::vsyncDistributor->AddConnection(VSyncConnectionTest::vsyncConnection);
 ...
 */
TEST_F(VSyncConnectionTest, GetReceiveFd001)
{
    int32_t fd = -1;
