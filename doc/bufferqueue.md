...
![bufferqueue](picture/bufferqueue.png)
...
![RSSurfaceOhosGl](picture/RSSurfaceOhosGl.png)
...
![RenderService](picture/RenderService.png)
...
![HdiBackend](picture/HdiBackend.png)
...
![ClockDemoRun](picture/ClockDemoRun.png)
...
![draw_RequestFrame](picture/draw_RequestFrame.png)
...
![request_mesa](picture/request_mesa.png)
...
![draw_RequestBuffer](picture/draw_RequestBuffer.png)

因此，在应用程序申请内存时，会进行两次 `IPC` 跨进程调用。

![alloc](picture/alloc.png)
...
![draw_flushframe](picture/draw_flushframe.png)
...
![RSMainThreadRequestNextVSync](picture/RSMainThreadRequestNextVSync.png)

### 3.2. 消费者 Render Service
...
![draw_bufferqueue](picture/draw_bufferqueue.png)

## 4. 合成 BufferQueue

进入 `RSMainThread::Render()` 后，会进行合成 `BufferQueue` 的生产消费流程。

### 4.1. 生产者 Render Service

下图展示了 `RSPhysicalScreenProcessor::Redraw()` 的运行过程。

![RSPhysicalScreenProcessorRedraw](picture/RSPhysicalScreenProcessorRedraw.png)

#### 4.1.1. Request

![comp_request](picture/comp_request.png)

#### 4.1.2. Flush

![comp_flush](picture/comp_flush.png)
...
![HdiBackendRepaint](picture/HdiBackendRepaint.png)
